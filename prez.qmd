...
title-slide-attributes: 
  data-background-image: images/MSME.jpg, images/Logo_Centre_national_de_la_recherche_scientifique_\(2023-\).svg, images/Logo_Université_Gustave_Eiffel_2020.svg
  data-background-size: 12%, 12%, 12%
  data-background-position: 25% 65%, 50% 65%, 75% 65%
